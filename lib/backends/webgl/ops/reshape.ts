...
export function reshape(
  ...
  const inputTD = inferenceHandler.createTextureData(input);
  ...
  const newTextureData = inferenceHandler.createTextureData(input.type, newTextureLayout, inputTD.texture);
